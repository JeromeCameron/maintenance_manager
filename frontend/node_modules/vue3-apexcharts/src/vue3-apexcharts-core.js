...
const vueApexchartsCore = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // Function values (e.g. axis label formatters) are preserved rather than
    // dropped, since JSON.stringify would otherwise strip them and cause
    // ApexCharts to fall back to its default (over-precise) number formatting.
    const copyData = (data) => {
